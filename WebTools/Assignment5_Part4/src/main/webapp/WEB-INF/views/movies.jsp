...
<html>
    ...
    <body style="background-color: #80CBC4;">
        ...
        <div class="container">
            <c:if test="${path =='1'}">
                <h1>Search Movie</h1>
                <form class="well form-horizontal" name="searchMovieForm" method="POST" action="movie1.htm" onsubmit="return validateForm()" style="background-color: #E1F5FE;">
            ...
            <c:if test="${path =='2'}">
                ...
                <form class="well form-horizontal" name="addMovieForm" method="POST" action="movie1.htm" style="background-color: #E1F5FE;">
